...
def sanitize_output_text(text):
    """Cleans up stray markdown brackets, characters, and accidental raw HTML tags."""
    if not text:
        return ""
    # Strip out any accidental raw HTML tags like <div> or <span> generated by the model
    cleaned = re.sub(r'<[^>]*>', '', text)
    # Strip structural braces, brackets, and matching quotation marks
